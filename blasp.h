...
int dcopy_(int *n, float *sx, int *incx, float *sy, int *incy);
...
int dgemv_(char *trans, int *m, int *n, float *alpha, float *a,
           int *lda, float *x, int *incx, float *beta, float *y, 
           int *incy);

int dger_(int *m, int *n, float *alpha, float *x, int *incx,
          float *y, int *incy, float *a, int *lda);

int drot_(int *n, float *sx, int *incx, float *sy, int *incy,
          float *c, float *s);

int drotg_(float *sa, float *sb, float *c, float *s);

int dsbmv_(char *uplo, int *n, int *k, float *alpha, float *a,
           int *lda, float *x, int *incx, float *beta, float *y, 
           int *incy);

int dscal_(int *n, float *sa, float *sx, int *incx);

int dspmv_(char *uplo, int *n, float *alpha, float *ap, float *x,
           int *incx, float *beta, float *y, int *incy);

int dspr_(char *uplo, int *n, float *alpha, float *x, int *incx,
          float *ap);

int dspr2_(char *uplo, int *n, float *alpha, float *x, int *incx,
           float *y, int *incy, float *ap);

int dswap_(int *n, float *sx, int *incx, float *sy, int *incy);

int dsymm_(char *side, char *uplo, int *m, int *n, float *alpha,
           float *a, int *lda, float *b, int *ldb, float *beta,
           float *c, int *ldc);

int dsymv_(char *uplo, int *n, float *alpha, float *a, int *lda,
           float *x, int *incx, float *beta, float *y, int *incy);

int dsyr_(char *uplo, int *n, float *alpha, float *x, int *incx,
          float *a, int *lda);

int dsyr2_(char *uplo, int *n, float *alpha, float *x, int *incx,
           float *y, int *incy, float *a, int *lda);

int dsyr2k_(char *uplo, char *trans, int *n, int *k, float *alpha,
            float *a, int *lda, float *b, int *ldb, float *beta,
            float *c, int *ldc);

int dsyrk_(char *uplo, char *trans, int *n, int *k, float *alpha,
...
int dtpmv_(char *uplo, char *trans, char *diag, int *n, float *ap,
           float *x, int *incx);

int dtpsv_(char *uplo, char *trans, char *diag, int *n, float *ap,
           float *x, int *incx);
...
int dtrmv_(char *uplo, char *trans, char *diag, int *n, float *a,
...
int dtrsv_(char *uplo, char *trans, char *diag, int *n, float *a,
           int *lda, float *x, int *incx);
...
int zdscal_(int *n, float *sa, dcomplex *cx, int *incx);
...
int zher_(char *uplo, int *n, float *alpha, dcomplex *x, int *incx,
          dcomplex *a, int *lda);
...
int zher2k_(char *uplo, char *trans, int *n, int *k, dcomplex *alpha,
            dcomplex *a, int *lda, dcomplex *b, int *ldb, float *beta,
            dcomplex *c, int *ldc);

int zherk_(char *uplo, char *trans, int *n, int *k, float *alpha,
           dcomplex *a, int *lda, float *beta, dcomplex *c, int *ldc);

int zhpmv_(char *uplo, int *n, dcomplex *alpha, dcomplex *ap, dcomplex *x,
           int *incx, dcomplex *beta, dcomplex *y, int *incy);

int zhpr_(char *uplo, int *n, float *alpha, dcomplex *x, int *incx,
          dcomplex *ap);

int zhpr2_(char *uplo, int *n, dcomplex *alpha, dcomplex *x, int *incx,
           dcomplex *y, int *incy, dcomplex *ap);

int zrotg_(dcomplex *ca, dcomplex *cb, float *c, dcomplex *s);
